...
var falas = ["Olá, meu chapa. Você infelizmente acabou de entrar 
em um purgatório da uerj." , "Aqui é onde todas as almas atormentadas dos estudantes ficam ao reprovarem pela primeira vez em Cálculo 1"
, "A maioria nunca havia experenciado a dor da reprovação, e quando isso acontece, infelizmente acabam ficando atormentadas" 
]
